(function (r) {
    ...
    b.processText = function (a) {
        var c = b.createTag("g"),
            f = b.createTag("defs"),
            d = b.createTag("g");
        if ("rs" in a) for (var g = 0; a.rs[g]; g++) {
            var e = a.rs[g];
            if (a.tt == "html") {
                var j = a.bd,
    ...
    b.processShape = function () {
        var a = function (a, d, g) {
            ...
            c = function (a, c) {
                ...
                for (e in a.image) e == "xlink:href" ? j.setAttributeNS("http://www.w3.org/1999/xlink", "href", a.image[e]) : j.setAttribute(e, a.image[e]);
                g.appendChild(j);
                g.setAttribute("id", c);
                b.defs.appendChild(g);
                return c
        ...
        return function (f) {
            ...
            d.appendChild(g);
            d.appendChild(e);
            if (g = f.pt) for (var j = 0, o = g.length; j < o; j++) {
                var h = g[j],
                    k = b.createTag("path");
                ...
                if (typeof h.fi !== "undefined") {
                    ...
                    if (l) {
                        var q = k,
                            n = i;
                        i = l.tp;
                        if (i == 1) q.setAttribute("fill", l.c),
                        q.setAttribute("fill-opacity", typeof l["fill-opacity"] == "undefined" ? 1 : l["fill-opacity"]);
                        else {
                            m = "f" + n + ":" + m;
                            n = "";
                            switch (i) {
    ...
    b.filterElement = function (a, c) {
        ...
        this.Glow = function (a) {
            ...
            this.Fg(a.bx, a.by);
            a.op & 128 && this.Com("arithmetic", !1, d(this.base), -1, 1);
            a.op & 128 ? this.Rgba(a.st, a.c, d(this.base)) : this.Rgba(a.st, a.c, ++this.base);
        ...
        this.Bevel = function (a) {
            this.Rgb(d(this.base)).Fg(a.bx, a.by).Fo("-" + a.dx, "-" + a.dy, ++this.base).Rgb(d(this.base - 1)).Fg(a.bx, a.by).Fo(a.dx, a.dy, ++this.base).Com("arithmetic", d(this.base - 1), d(this.base), 1, -1).Rgba(a.st, a.highlightColor, ++this.base).Com("arithmetic", d(this.base - 1), d(this.base - 2), 1, -1).Rgba(a.st, a.c, ++this.base).Com("arithmetic", d(this.base - 1), d(this.base), 1, 1, ++this.base);
            a.op & 64 ? a.op & 16 || (a.op & 128 ? this.Com("in", this.base, d(this.base - 5), 0, 0, ++this.base) : this.Com("out", this.base, d(this.base - 5), 0, 0, ++this.base)) : a.op & 128 ? this.Com("atop", this.base, d(this.base - 5), 0, 0, ++this.base) : a.op & 16 ? this.Com("over", this.base, d(this.base - 5), 0, 0, ++this.base) : this.Com("over", d(this.base - 5), this.base, 0, 0, ++this.base)
        };
        this.init = function () {
        ...
        for (var h = {}, k = 0, l = this.placeObjects.length; k < l; k++) {
            ...
            if (!(i.tp == 14 || i.tp == 43)) {
                ...
                if (i.tp == 1) {
                    ...
                    g = e.slice();
                    g.push(i);
                    if (o.length > 0) for (a = 0; a < o.length; a++) for (var q in h)(o[a] == h[q] || o[a].d == h[q].d) && delete h[q];
                    this.frames.push(g);
                    g = [];
                    g = [];
                    j = [];
    ...
    b.sprite.prototype.showFrame = function () {
        for (var a = this.frames[this.frame], c = a[a.length - 1], b = null, d = 0, g = a.length - 1; d < g; d++) b = a[d],
        this.renderShape(b),
        this.lastDepth = b.d;
        this.lastDepth = null;
    ...
    b.sprite.prototype.replaceShape = function (a) {
        ...
        if (this.depths[d]) {
            ...
            this.buttons && this.buttons[d + ":" + this.depths[d]] && (this.buttons[d + ":" + this.depths[d]] = null, delete this.buttons[d + ":" + this.depths[d]])
        } else {
            if (this.lastDepth) {
    ...
    b.sprite.prototype.moveShape = function (a, c) {
        ...
        else for (var d = a.childNodes, g = 0, e = d.length; g < e; g++) d[g].setAttribute("transform", "matrix(" + b + ")")
    };
    ...
    b.sprite.prototype.moveButton = function (a, c) {
        ...
        if (this.buttons[f + ":" + d]) for (var j in e = this.buttons[f + ":" + d].sprites, e) e[j].showFrame();
    ...
    b.sprite.Button.prototype = {
        init: function (a) {
            ...
            for (var f = a.rc, d, g, e, j = f.length - 1; j >= 0; j--) d = f[j],
            e = d.s,
        ...
        changeState: function (a) {
            for (var c = this.element.childNodes, b = 0, d; d = c[b]; b++) d.style.display = d.getAttribute("state") == "hit" || d.getAttribute("state") == a ? "block" : "none"
        }
    };
    ...
    b.sprite.prototype.colorTransform = function () {
        ...
        return function (c, b) {
            ...
            if ((d == "shape" || d == "text") && c.nodeName.toLowerCase() != "clippath") {
